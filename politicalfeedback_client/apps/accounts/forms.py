...
class RegistraForm(forms.Form):
	...
	telefono.widget.attrs['class'] = 'input-group-field'
	email = forms.EmailField(required=True)
	email.widget.attrs['placeholder'] = 'email'
	email.widget.attrs['class'] = 'input-group-field'
	...
	provincia.widget.attrs['class'] = 'input-group-field'
	citta = forms.ModelChoiceField(comuni,required=True)
	citta.widget.attrs['required'] = 'required'
	citta.widget.attrs['class'] = 'input-group-field hide'
...
class LoginForm(forms.Form):
	...
	username.widget.attrs['class'] = 'input-group-field'
	password = forms.CharField(widget=forms.PasswordInput)
	password.widget.attrs['required'] = 'required'
	password.widget.attrs['placeholder'] = 'password'
	password.widget.attrs['class'] = 'input-group-field'
